            ...
            <div className="card bg-white shadow-sm border border-gray-100 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-3 gap-4">
                <button onClick={() => { onButtonClick('Call'); notify('Call'); }}
                  className="flex flex-col items-center justify-center gap-2 p-4 shadow-md hover:border rounded-md bg-[#f8fafc] h-28 transition-all duration-300 hover:border-[#244D3F] hover:-translate-y-1 hover:shadow-lg">
                ...
                <button onClick={() => { onButtonClick('Video'); notify('Video'); }}
                  className="flex flex-col items-center justify-center gap-2 p-4 hover:border rounded-md shadow-md bg-[#f8fafc] h-28 transition-all duration-300 hover:border-[#244D3F] hover:-translate-y-1 hover:shadow-lg">
